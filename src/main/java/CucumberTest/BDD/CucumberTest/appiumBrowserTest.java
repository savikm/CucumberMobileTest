...
import org.openqa.selenium.By; import org.openqa.selenium.JavascriptExecutor;
  ...
  import org.openqa.selenium.interactions.touch.TouchActions; import
...
import io.appium.java_client.AppiumDriver; import
  io.appium.java_client.MobileBy; import
  io.appium.java_client.android.AndroidDriver; import
  io.appium.java_client.android.nativekey.AndroidKey; import
  io.appium.java_client.android.nativekey.KeyEvent; import
  io.appium.java_client.service.local.AppiumDriverLocalService; import
  io.appium.java_client.service.local.AppiumServiceBuilder; import
  io.appium.java_client.service.local.flags.ServerArgument;
  
  public class appiumBrowserTest {
  
  WebDriver driver; DesiredCapabilities caps= new DesiredCapabilities();
  ...
  @Test public void ANZWebAppTest() throws MalformedURLException,
  ...
  WebElement ApplicationType= driver.findElement(By.
  xpath("//label[contains(text(),'Application type')]/parent::div//label[contains(text(),'Single')]"
  ...
  Select NumOfDependents=new
  Select(driver.findElement(By.xpath("//Select[@title='Number of dependants']")
  )); NumOfDependents.selectByVisibleText("1");
  
  WebElement PropertyType= driver.findElement(By.
  xpath("//label[contains(text(),'Property you would like to buy')]/parent::div//label[@for='borrow_type_home']"
  )); PropertyType.click();
  
  WebElement IncBeforeTax= driver.findElement(By.
  xpath("//label[text()='Your income (before tax)']/parent::div//input"));
  IncBeforeTax.sendKeys("80000");
  
  WebElement OtherInc= driver.findElement(By.
  xpath("//label[text()='Your other income']/parent::div//input"));
  OtherInc.sendKeys("500");
  
  WebElement LivExpense= driver.findElement(By.
  xpath("//label[text()='Living expenses']/parent::div//input"));
  LivExpense.sendKeys("10000");
  
  WebElement CurHomeLoanRepay= driver.findElement(By.
  xpath("//label[text()='Current home loan repayments']/parent::div//input"));
  CurHomeLoanRepay.sendKeys("100");
  
  WebElement OthLoanComit= driver.findElement(By.
  xpath("//label[text()='Other loan repayments']/parent::div//input"));
  OthLoanComit.sendKeys("10000");
  
  WebElement OthComit= driver.findElement(By.
  xpath("//label[text()='Other commitments']/parent::div//input"));
  OthComit.sendKeys("40");
  
  WebElement CredLimit= driver.findElement(By.
  xpath("//label[text()='Total credit card limits']/parent::div//input"));
  CredLimit.sendKeys("50");
  
  WebElement AnzRepaycal=
  driver.findElement(By.xpath("//a[text()='ANZ repayments calculator']"));
  AnzRepaycal.click();
  
  
  WebElement LoanAmountVer = (new WebDriverWait(driver,
  10)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
  "//div[@id='loan']//div[@role='slider']")));
  
  Thread.sleep(5000);
  
  WebElement LoanAmountVerRe=
  driver.findElement(By.xpath("//div[@id='loan']//div[@role='slider']"));
  System.out.println("Loan amount calculated as: "+LoanAmountVerRe.getAttribute
  ("aria-valuemin"));
  System.out.println("Loan amount calculated as new: "+LoanAmountVerRe.
  getAttribute("aria-valuenow"));
  
  driver.quit(); //Assert.assertEquals("50001",
